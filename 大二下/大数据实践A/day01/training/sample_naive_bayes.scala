...
object sample_naive_bayes {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //保存模型
    //model.save(sc,"inputdata/sample_naive_bayes")
    //val sameple = NaiveBayesModel.load("inputdata/sample_naive_bayes")
    sc.stop()
  }
